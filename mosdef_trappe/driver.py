...
def main():
    ...
    gmx_funcs.simulate(structure, temperature=300*u.Kelvin, n_steps=5000,
            pressure=None)
    import mosdef_trappe.openmm_util.openmm_functions as omm_funcs
    omm_funcs.simulate(structure, temperature=300*u.Kelvin, n_steps=5000,
            pressure=None)
    import mosdef_trappe.hoomd_util.hoomd_functions as hoomd_funcs
    hoomd_funcs.simulate(structure, temperature=300*u.Kelvin, n_steps=5000,
            pressure=None)
    import mosdef_trappe.gomc_util.gomc_functions as gomc_funcs
    gomc_funcs.simulate(structure, temperature=300*u.Kelvin)
